...
db= KMeans(n_clusters=100, precompute_distances=True)
...
first_cluster.to_csv('first_cluster_kmeans.csv', encoding='utf-8', index=False)
second_cluster.to_csv('second_cluster_kmeans.csv', encoding='utf-8', index=False)
three_cluster.to_csv('three_cluster_kmeans.csv', encoding='utf-8', index=False)
